# Price Rise Extended Checklist

### Price rising newspapers

Marketing usually only specify the target total price of the subscriptions, but double check with Finance what the computation should be for the rise of the individual legs, notably any difference between Digital Pack, versus the paper/delivery legs
