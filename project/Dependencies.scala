...
object Dependencies {
  ...
  private val awsSdkVersion = "2.41.21"
  ...
  lazy val http_sttp_client4_core = "com.softwaremill.sttp.client4" %% "core" % "4.0.19"
  lazy val http_sttp_client4_zio = "com.softwaremill.sttp.client4" %% "zio" % "4.0.19"
