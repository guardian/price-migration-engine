...
import pricemigrationengine.migrations.{DigiSubs2025Migration, Membership2025Migration, SupporterPlus2026Migration}
...
object EstimationHandlerHelper {
  ...
  def earliestAmendmentEffectiveDate(cohortSpec: CohortSpec): LocalDate = {
    MigrationType(cohortSpec) match {
      ...
      case Newspaper2025P3   => LocalDate.of(2025, 8, 13)
