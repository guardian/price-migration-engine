...
object AmendmentData {
  ...
  def priceData(
    ...
    MigrationType(cohortSpec) match {
      ...
      case Print2026C1GWAnnualsUK => GuardianWeekly2026X.priceData(cohortSpec, subscription, invoiceList, account)
      case Print2026C1GWQuarterliesUK => GuardianWeekly2026X.priceData(cohortSpec, subscription, invoiceList, account)
      case Print2026C1NPAnnualsUK     => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C1NPQuarterliesUK => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C1NPSemiannualsUK => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C2NPMonthliesUK   => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C3GWMonthliesUK   => GuardianWeekly2026X.priceData(cohortSpec, subscription, invoiceList, account)
      case Print2026C3NPMonthliesUK   => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C4NPMonthliesUK   => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C5GW              => GuardianWeekly2026X.priceData(cohortSpec, subscription, invoiceList, account)
      case Print2026C5NP              => Newspaper2026X.priceData(cohortSpec, subscription, invoiceList, account, today)
      case Print2026C6GWQuarterliesNonUK =>
        GuardianWeekly2026X.priceData(cohortSpec, subscription, invoiceList, account)
    }
  }
}
