...
object Conversions {
  ...
  def getCohortTableFilter(result: util.Map[String, AttributeValue],
                           fieldName: String): Either[String, CohortTableFilter] =
    for {
      string <- getStringFromResults(result, fieldName)
  ...
  def getOptionalStringFromResults(result: util.Map[String, AttributeValue],
                                   fieldName: String): Either[String, Option[String]] =
    result.asScala
      .get(fieldName)
  ...
  def getOptionalNumberStringFromResults(result: util.Map[String, AttributeValue],
                                         fieldName: String): Either[String, Option[String]] =
    result.asScala
      .get(fieldName)
      .fold[Either[String, Option[String]]](Right(None)) { attributeValue =>
  ...
  def getOptionalDateFromResults(result: util.Map[String, AttributeValue],
                                 fieldName: String): Either[String, Option[LocalDate]] =
    for {
      optionalString <- getOptionalStringFromResults(result, fieldName)
  ...
  def getOptionalBigDecimalFromResults(result: util.Map[String, AttributeValue],
                                       fieldName: String): Either[String, Option[BigDecimal]] =
    for {
  ...
  def getOptionalInstantFromResults(result: util.Map[String, AttributeValue],
                                    fieldName: String): Either[String, Option[Instant]] =
    for {
