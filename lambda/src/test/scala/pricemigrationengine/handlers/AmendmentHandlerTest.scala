...
class AmendmentHandlerTest extends munit.FunSuite {
  test("Membership2023 Amendment Batch1") {
    ...
    val update = ZuoraSubscriptionUpdate.updateOfRatePlansToCurrent_Membership2023_Monthlies(
      subscription,
      invoicePreview,
  ...
  test("Membership2023 Amendment Batch3") {
    ...
    val update = ZuoraSubscriptionUpdate.updateOfRatePlansToCurrent_Membership2023_Annuals(
      subscription,
      invoicePreview,
      effectiveDate: LocalDate
    )
