...
1. We spread the start dates out randomly for each subscription [over 3 months](./src/main/scala/pricemigrationengine/handlers/EstimationHandler.scala#L78-L80). 
